...
public interface TrainerDetailService {
    // 트레이너 프로필 생성
    Long createTrainerProfile(TrainerProfileDTO trainerProfile, PrincipalDetails user, String[] skills, List<MultipartFile> files) throws IOException;
    ...
    void updateTrainerGrantStatus(Long trainerId, GrantStatus status);
}
